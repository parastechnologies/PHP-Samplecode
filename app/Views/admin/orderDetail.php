                                    ...
                                    <table class="table ms-profile-information">
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td scope="row"><?php echo $order['name']; ?></td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                             ...
                                             <td scope="row"><?php echo $order['phoneCode'].$order['phoneNumber']; ?></td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td scope="row"><?php echo $order['shipAddress'].'&nbsp;'.$order['shipCountry'].'&nbsp;'.$order['shipZipcode']; ?></td>
                                          </tr>
                                          <tr>
                                             <td scope="row" class="h_text">
                                                <b>
                                             ...
                                             <td scope="row"><?php echo $order['billingAddress'].'&nbsp;'.$order['billingCountry'].'&nbsp;'.$order['billingZipcode']; ?></td>
                                          </tr>
                                       </tbody>
                                    </table>
                                 </div>
                        ...
                        <tr class="selected" role="row">
                           ...
                           <td>
                              <div class="icon_imgs">
                                 <div class="main-icn">
                                    <?php if($item['image']){ ?>
                                    <img src="<?php echo $adminProductPath.$item['image']; ?>" class="me-2" width="85" height="85" alt=""> 
                                    <?php } else { ?>
