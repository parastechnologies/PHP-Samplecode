         ...
         <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php    
             ...
             <div>
          <div class="col-md-12">
              <center><p class="align-items-center"><b>order has been already cancelled.</b></p></br>
              <a class="black_btn" href="<?php echo base_url(); ?>">Back To Home</a></center>
         </div>
         </div>
            <?php  } else { ?>
            <div class="col-md-12">
              <center><p class="align-items-center"><b>Your Payment has been cancelled due to some reasons.</b></p>
         </div>
         </div>
         <?php } ?>
         </div>
