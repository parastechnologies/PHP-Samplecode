...
var initialElements  = function(canvas_info) {
    ...
    <input type="hidden" id="PID" name="PID" value="<?php echo $uri->getSegment(3); ?>">
...
$(this).each(function (delta) {
     ...
     var canvas_info = {
        ...
        i18n:{fontFamilyText: 'Font Family',
             ...
             resetText: 'Reset',
             imageGeneratorText: 'Add to cart',
...
//$("#check").on( "click", "#check", function(event){ 
